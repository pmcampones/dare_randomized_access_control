...
func TestShouldMakeNode(t *testing.T) {
	...
	n := NewNode(func(_ int, _ []uuid.UUID) error {
...
func TestShouldRunSequential(t *testing.T) {
	...
	nodes = append(nodes, NewNode(func(_ int, _ []uuid.UUID) error {
...
func TestShouldRunConcurrent(t *testing.T) {
	...
	firstNode := NewNode(func(_ int, _ []uuid.UUID) error { return nil }, nil)
	for i := 0; i < numNodes; i++ {
		NewNode(func(_ int, _ []uuid.UUID) error {
...
func TestShouldNotExecuteTwice(t *testing.T) {
	...
	firstNode := NewNode(func(_ int, _ []uuid.UUID) error {
		executed = append(executed, vals[0])
		return nil
	}, nil)
	upNode := NewNode(func(_ int, _ []uuid.UUID) error {
		executed = append(executed, vals[1])
		return nil
	}, []*OpNode{firstNode})
	downNode := NewNode(func(_ int, _ []uuid.UUID) error {
